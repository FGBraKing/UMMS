...
class DsbnFuseWithDeepPriorSupervisedModel(BaseModel):
    def __init__(self, opt):
        super(DsbnFuseWithDeepPriorSupervisedModel, self).__init__(opt)
    ...
    def backward(self):
        with self.autocast_context():
            ...
            self.loss_total = self.loss_routine + self.loss_regular + self.loss_prior + self.loss_feature
