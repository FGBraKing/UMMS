...
from models.modules.MultimodalSegmentation.DomainSpecificNormalization import ChilopodUnet, BinaryKDLoss
...
class DsbnWithPriorModel(BaseModel):
    def __init__(self, opt):
        super(DsbnWithPriorModel, self).__init__(opt)
