...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netG_A = define_G(opt.input_nc,
                               opt.output_nc,
                               opt.ngf,
                               opt.netG,
                               opt.norm,
                               ...
                               opt.init_gain,
                               self.gpu_ids)
        self.netG_B = define_G(opt.output_nc,
                               opt.input_nc,
                               opt.ngf, opt.netG,
                               opt.norm,
                               not opt.no_dropout,
        ...
        if self.isTrain:  # define discriminators
            self.netD_A = define_D(opt.output_nc,
                                   opt.ndf,
                                   opt.netD,
                                   opt.n_layers_D,
                                   opt.norm,
                                   ...
                                   opt.init_gain,
                                   self.gpu_ids)
            self.netD_B = define_D(opt.input_nc,
                                   opt.ndf,
                                   opt.netD,
                                   opt.n_layers_D,
                                   opt.norm,
