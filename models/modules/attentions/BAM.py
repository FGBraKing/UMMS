...
class ChannelAttention(nn.Module):
    ...
    def forward(self, x):
        res = self.avgpool(x)   # n,c,1,1,1
        res = self.ca(res)   # n, channel
...
class SpatialAttention(nn.Module):
    def __init__(self, channel, reduction=16, num_layers=3, dia_val=2):
        ...
        self.sa.add_module('conv_reduce1', nn.Conv3d(kernel_size=1, in_channels=channel, out_channels=channel//reduction))
